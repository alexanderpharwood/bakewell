'use strict';
var appId = "racing-app";

$('.ui-window').removeClass('active');


var jsRef = '<script src="webapp/apps/racing-app/common.js"></script>';
jsRef += '<script src="webapp/apps/racing-app/stats.js"></script>';
...
BAKEWELL.appProccess[appId].appState = {
    "additionalCss": "width: 700px; height: 600px; min-width: 700px; min-height: 600px;"
};
